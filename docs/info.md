...
## CPU features:
-	12-bit Instruction Pointer (xx bytes ROM for code space are implemented)
-	11-bit Data Pointer (yy words RAM for data space are implemented)
-	8-bit Stack Pointer (zz words stack are implemented)
...
![Figure-19](Nano_SPI_transfer_words.png)
...
![Figure-20](Nano_SPI_Address_MAP.png)
